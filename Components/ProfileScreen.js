...
export default function ProfileScreen({navigation, route}) {
    ...
    const URL_ROOT = 'https://lab-nodejs-mob402.herokuapp.com/';
    const URL_CHANGE_AVATAR = 'https://lab-nodejs-mob402.herokuapp.com/avatar.id=' + user._id;
    const URL_UPDATE = 'https://lab-nodejs-mob402.herokuapp.com/user.id=' + user._id;
